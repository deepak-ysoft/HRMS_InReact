...
export const validateForm = (form: Candidate) => {
  ...
  errors.contact_No =
    validateRequired(form.contact_No, "Contact Number") ||
    validatePhoneNumber(form.contact_No, "Contact Number");

  // Email validation (required + email format)
  errors.email_ID =
    validateRequired(form.email_ID, "Email") || validateEmail(form.email_ID);
